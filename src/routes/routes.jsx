      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            >
              <div style={{ fontSize: 'clamp(35px, 5vw, 50px)', marginBottom: '10px', color: '#e67e22' }}>🍴</div>
              <div style={{ fontSize: 'clamp(13px, 2vw, 16px)', color: '#2c3e50', fontWeight: '600' }}>Gastorómia</div>
            </div>
            <div style={{
              backgroundColor: 'white',
              padding: '25px 20px',
